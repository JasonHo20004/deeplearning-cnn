...
def get_args():
    ...
    parser.add_argument('-r', '--data-root', type=str, default='../../dataML', help='Dataset root path.')
    # parser.add_argument('-d', '--dataset', choices=['cifar10', 'cifar100', 'dogs'], required=True, help='Dataset name.')
    parser.add_argument('-d', '--dataset', type=str, choices=['cifar10', 'cifar100', 'dogs'], default='cifar10',
                        help='Dataset name.')
...
def main():
    ...
    pathout = './checkpoints/CIFAR10_MDFNet'
    filenameLOG = pathout + '/' + '.txt'
