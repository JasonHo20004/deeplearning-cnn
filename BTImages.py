# -*- coding: utf-8 -*-
"""
Created on Wed Mar 18 09:59:25 2026
...
def main():
    ...
    # create model
    # n_class = 30
    # args.data = path_ReIN + '/ReIN' + str(n_class)
    n_class = 5
    args.data = './ReIN30'  
    args.arch = 'BTImages' + str(n_class) + '_NetBT3'  
    ...
    train_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.workers, pin_memory=use_pin, sampler=train_sampler)
